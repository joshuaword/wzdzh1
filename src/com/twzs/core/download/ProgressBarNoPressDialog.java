...
public class ProgressBarNoPressDialog extends AlertDialog {
	/**
	...
	public ProgressBarNoPressDialog(Context context) {
		super(context);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mProgressStyle == STYLE_HORIZONTAL) {
			...
			View view = inflater.inflate(R.layout.app_alert_dialog_no_progress,
					null);
