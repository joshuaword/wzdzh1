...
import com.twzs.zouyizou.photo.zoom.ViewPagerFixed;
...
public class GalleryActivity extends Activity {
	...
	public void isShowOkBt() {
		if (Bimp.tempSelectBitmap.size() > 0) {
			send_bt.setText(Res.getString("finish")+"(" + (Bimp.tempSelectBitmap.size()+ChatActivity.all_photoList.size()-1) + "/"+PublicWay.num+")");
