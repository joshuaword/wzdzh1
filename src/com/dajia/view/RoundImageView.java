 ...
 * 
 * use
 *   直接在布局中使用，圆形ImageView，可带或不带 一个或两个或零个圆边框
 *   
 *    <!-- 圆形的，不带圆边框 -->
 *    <com.linkage.lejia.pub.widget.RoundImageView
            android:id="@+id/roundImage_network"
            android:layout_width="60dp"
            android:layout_height="60dp"
            android:src="@drawable/ic_launcher" />
		<!-- 只有一个imagecontrol:border_outside_color 时，代表只有一个圆边框 -->
        <com.linkage.lejia.pub.widget.RoundImageView
		...
		<!-- 当有border_inside_color与border_outside_color 时，代表有两个圆边框 -->
        <com.linkage.lejia.pub.widget.RoundImageView
