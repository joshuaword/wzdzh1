...
public class Result {
	...
	public final String SUCCESS_CODE = "9000";
	...
	static {
		...
		sResultStatus.put("4000", "您的系统异常");
		sResultStatus.put("4001", "您请求的数据格式不正确");
		sResultStatus.put("4003", "您绑定的支付宝账户被冻结或不允许支付");
		sResultStatus.put("4004", "您已解除绑定");
		sResultStatus.put("4005", "您绑定失败或没有绑定");
		sResultStatus.put("4006", "您的订单支付失败,请重试");
		sResultStatus.put("4010", "您重新绑定了账户");
		sResultStatus.put("6000", "您的支付服务正在进行升级操作");
		sResultStatus.put("6001", "您已取消支付操作");
		sResultStatus.put("7001", "您的网页支付失败");
	}
	...
	public String getErrorMsg(String rs){
