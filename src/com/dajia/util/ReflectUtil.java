...
public class ReflectUtil {
    ...
    public static boolean isArrayDataType(Object o) {
        if ((o instanceof boolean[]) || (o instanceof char[]) || (o instanceof byte[]) || (o instanceof short[])
            ...
            || (o instanceof Boolean[]) || (o instanceof Character[]) || (o instanceof Byte[])
            || (o instanceof Short[]) || (o instanceof Integer[]) || (o instanceof Long[]) || (o instanceof Float[])
            || (o instanceof Double[]) || (o instanceof String[]) || (o instanceof Collection)) {
            return true;
        }
        return false;
    }
        ...
        if (clazz == boolean.class || clazz == Boolean.class) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ((List)obj).add(flag ? getObjectFromString(genericClass, jsonArray.getString(i))
                        : copy(genericClass, jsonArray.getJSONObject(i)));
    ...
    /**
     * cast string to a Object by given Class,not support List銆乤rray data type and etc
     * @param clazz
     * @param s
     * @return
     * @throws ReflectException
